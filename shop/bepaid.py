...
class Bepaid:
    ...
    def bp_token(self, total_price):
        ...
        response = requests.post(self.url, json=payload, headers={'Accept': 'application/json'},
                                 auth=HTTPBasicAuth('3013',
                                                    '85b45d21923689cae8026b90a5f832f2221bede68265b566b86cdfd7ba21de41'))
        response.json()
        if settings.DEBUG:
